...
type CalendarClient interface {
	FindEventsByDay(ctx context.Context, in *FindDayEventsRequest, opts ...grpc.CallOption) (*FindDayEventsResponse, error)
	FindEventsByWeek(ctx context.Context, in *FindWeekEventsRequest, opts ...grpc.CallOption) (*FindWeekEventsResponse, error)
	FindEventsByMonth(ctx context.Context, in *FindMonthEventsRequest, opts ...grpc.CallOption) (*FindMonthEventsResponse, error)
...
func (c *calendarClient) FindEventsByDay(ctx context.Context, in *FindDayEventsRequest, opts ...grpc.CallOption) (*FindDayEventsResponse, error) {
	out := new(FindDayEventsResponse)
	err := c.cc.Invoke(ctx, "/event.Calendar/FindEventsByDay", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *calendarClient) FindEventsByWeek(ctx context.Context, in *FindWeekEventsRequest, opts ...grpc.CallOption) (*FindWeekEventsResponse, error) {
	out := new(FindWeekEventsResponse)
	err := c.cc.Invoke(ctx, "/event.Calendar/FindEventsByWeek", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *calendarClient) FindEventsByMonth(ctx context.Context, in *FindMonthEventsRequest, opts ...grpc.CallOption) (*FindMonthEventsResponse, error) {
	out := new(FindMonthEventsResponse)
	err := c.cc.Invoke(ctx, "/event.Calendar/FindEventsByMonth", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CalendarServer interface {
	FindEventsByDay(context.Context, *FindDayEventsRequest) (*FindDayEventsResponse, error)
	FindEventsByWeek(context.Context, *FindWeekEventsRequest) (*FindWeekEventsResponse, error)
	FindEventsByMonth(context.Context, *FindMonthEventsRequest) (*FindMonthEventsResponse, error)
...
func (UnimplementedCalendarServer) FindEventsByDay(context.Context, *FindDayEventsRequest) (*FindDayEventsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method FindEventsByDay not implemented")
}
func (UnimplementedCalendarServer) FindEventsByWeek(context.Context, *FindWeekEventsRequest) (*FindWeekEventsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method FindEventsByWeek not implemented")
}
func (UnimplementedCalendarServer) FindEventsByMonth(context.Context, *FindMonthEventsRequest) (*FindMonthEventsResponse, error) {
...
func _Calendar_FindEventsByDay_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FindDayEventsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CalendarServer).FindEventsByDay(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/event.Calendar/FindEventsByDay",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CalendarServer).FindEventsByDay(ctx, req.(*FindDayEventsRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Calendar_FindEventsByWeek_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FindWeekEventsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CalendarServer).FindEventsByWeek(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/event.Calendar/FindEventsByWeek",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CalendarServer).FindEventsByWeek(ctx, req.(*FindWeekEventsRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Calendar_FindEventsByMonth_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FindMonthEventsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CalendarServer).FindEventsByMonth(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/event.Calendar/FindEventsByMonth",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CalendarServer).FindEventsByMonth(ctx, req.(*FindMonthEventsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _Calendar_FindEventsByDay_Handler,
		},
		{
			MethodName: "FindEventsByWeek",
			Handler:    _Calendar_FindEventsByWeek_Handler,
		},
		{
			MethodName: "FindEventsByMonth",
			Handler:    _Calendar_FindEventsByMonth_Handler,
		},
		{
